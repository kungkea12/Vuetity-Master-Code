<template>
    <v-card color="white" class="rounded-lg mt-2">
        <v-row>
            <v-col cols="12" sm="4">
                <v-card color="#42b883" class="rounded-lg px-2" flat>
                    <v-row>    
                        <v-col cols="12" sm="4">
                            <v-avatar>
            ...
            <v-col cols="12" sm="3">
                <v-card color="transparent" class="rounded-lg mx-2 px-2" flat>
                    ...
                    <h5 class="black--text mb-7">+855 969771023</h5>
            ...
            <v-col cols="12" sm="5">
                <v-card color="transparent" class="rounded-lg px-2" flat>
                    ...
                    <span class="caption grey--text">Medical Condition</span>
